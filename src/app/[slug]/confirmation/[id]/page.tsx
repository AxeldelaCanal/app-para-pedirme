...
export default function Confirmation({ params }: { params: Promise<{ slug: string; id: string }> }) {
      ...
      <main className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-3xl p-8 text-center flex flex-col items-center gap-6 shadow-2xl">
            ...
            <Link href={`/${slug}`} className="w-full rounded-2xl bg-slate-900 py-4 font-semibold text-white text-center">
